...
ax[1].imshow(edge_LOG, cmap=plt.cm.gray)
ax[1].set_title('LOG Edge Detection')

ax[2].imshow(edge_prewitt_h, cmap=plt.cm.gray)
ax[2].set_title('Prewitt_h Edge Detection')

ax[3].imshow(edge_prewitt_v, cmap=plt.cm.gray)
ax[3].set_title('Prewitt_v Edge Detection')
